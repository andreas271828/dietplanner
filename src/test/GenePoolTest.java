    ...
    private static MealTemplates getMealTemplatesDayMix() {
        ...
        mealTemplates.add(new MealTemplate("Day Mix") {
            ...
            protected void addIngredients() {
                ...
                // TODO: Continue here with defining upper limits
                addIngredientByWeight(COLES_BEAN_GREEN, 0.0, 1.0);
                addIngredientByWeight(COLES_BEEF_FILLET_STEAK, 0.0, 1.0);
                addIngredientByWeight(COLES_BEEF_HEART, 0.0, 1.0);
                addIngredientByWeight(COLES_BEEF_KIDNEY, 0.0, 1.0);
                addIngredientByWeight(COLES_BEEF_ROASTING_CUTS, 0.0, 1.0);
                addIngredientByWeight(COLES_BEEF_RUMP_STEAK, 0.0, 1.0);
                addIngredientByWeight(COLES_BEEF_T_BONE_STEAK, 0.0, 1.0);
                addIngredient(COLES_BEETROOT, 0.0, 1.0);
                addIngredientByWeight(COLES_BLUEBERRY_FROZEN, 0.0, 1.0);
                addIngredientByWeight(COLES_BOK_CHOY, 0.0, 1.0);
                addIngredientByWeight(COLES_BREAD_MIXED_GRAIN, 0.0, 1.0);
                addIngredientByWeight(COLES_BROCCOLI, 0.0, 1.0);
                addIngredientByWeight(COLES_BRUSSELS_SPROUT, 0.0, 1.0);
                addIngredientByWeight(COLES_BUTTER, 0.0, 1.0);
                ...
                addIngredientByWeight(COLES_CELERY, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_CHEDDAR, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_COLBY, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_COTTAGE_REDUCED_FAT, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_CREAM, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_FETTA, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_GOAT, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_GOUDA, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_HALOUMI, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_MOZZARELLA, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_PARMESAN, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_RICOTTA, 0.0, 1.0);
                addIngredientByWeight(COLES_CHEESE_SWISS, 0.0, 1.0);
                addIngredientByWeight(COLES_CHICKEN_BREAST_FREE_RANGE, 0.0, 1.0);
                addIngredientByWeight(COLES_CHICKEN_DRUMSTICK_FREE_RANGE, 0.0, 1.0);
                addIngredientByWeight(COLES_CHICKEN_LIVER, 0.0, 1.0);
                addIngredientByWeight(COLES_CHICKEN_THIGH_FREE_RANGE, 0.0, 1.0);
                addIngredient(COLES_CHICKEN_FREE_RANGE, 0.0, 1.0);
                addIngredientByWeight(COLES_CHICKEN_WING, 0.0, 1.0);
                addIngredientByWeight(COLES_CHICKPEA, 0.0, 1.0);
                addIngredientByWeight(COLES_CHOCOLATE_DARK_ORGANIC, 0.0, 1.0);
                addIngredientByWeight(COLES_COCONUT_OIL_ORGANIC, 0.0, 1.0);
                addIngredientByWeight(COLES_CREAM_PURE, 0.0, 1.0);
                addIngredientByWeight(COLES_CREAM_DOUBLE, 0.0, 1.0);
                addIngredientByWeight(COLES_CREAM_SOUR, 0.0, 1.0);
                addIngredient(COLES_CUCUMBER, 0.0, 1.0);
                addIngredientByWeight(COLES_DILL, 0.0, 1.0);
                addIngredientByWeight(COLES_EGG_CHICKEN_FREE_RANGE, 0.0, 1.0);
                addIngredientByWeight(COLES_GARLIC, 0.0, 1.0);
                addIngredientByWeight(COLES_GHEE, 0.0, 1.0);
                addIngredientByWeight(COLES_GINGER, 0.0, 1.0);
                addIngredientByWeight(COLES_HAM_LEG, 0.0, 1.0);
                addIngredientByWeight(COLES_HONEY, 0.0, 1.0);
                addIngredientByWeight(COLES_KALE, 0.0, 1.0);
                addIngredientByWeight(COLES_KANGAROO, 0.0, 1.0);
                addIngredient(COLES_KIWIFRUIT, 0.0, 1.0);
                addIngredientByWeight(COLES_LEEK, 0.0, 1.0);
                addIngredient(COLES_LEMON, 0.0, 1.0);
                addIngredientByWeight(COLES_LENTIL, 0.0, 1.0);
                addIngredientByWeight(COLES_LETTUCE, 0.0, 1.0);
                addIngredient(COLES_LIME, 0.0, 1.0);
                addIngredientByWeight(COLES_MACKEREL, 0.0, 1.0);
                addIngredient(COLES_MANDARIN, 0.0, 1.0);
                addIngredient(COLES_MANGO, 0.0, 1.0);
                addIngredientByWeight(COLES_MAYONNAISE, 0.0, 1.0);
                addIngredientByWeight(COLES_MILK_ALMOND, 0.0, 1.0);
                addIngredientByWeight(COLES_MILK_COW, 0.0, 1.0);
                addIngredientByWeight(COLES_MILK_GOAT, 0.0, 1.0);
                addIngredientByWeight(COLES_MUESLI_FRUIT, 0.0, 1.0);
                addIngredientByWeight(COLES_MUESLI_FRUIT_NUTS, 0.0, 1.0);
                addIngredientByWeight(COLES_MUSHROOM, 0.0, 1.0);
                addIngredient(COLES_MUSSEL_DRAINED, 0.0, 1.0);
                addIngredientByWeight(COLES_NUT_ALMOND, 0.0, 1.0);
                addIngredientByWeight(COLES_NUT_CASHEW, 0.0, 1.0);
                addIngredientByWeight(COLES_NUT_MACADAMIA, 0.0, 1.0);
                addIngredientByWeight(COLES_NUT_PECAN, 0.0, 1.0);
                addIngredientByWeight(COLES_NUT_WALNUT, 0.0, 1.0);
                addIngredientByWeight(COLES_OIL_OLIVE, 0.0, 1.0);
                addIngredientByWeight(COLES_OKRA, 0.0, 1.0);
                addIngredientByWeight(COLES_OLIVE_GREEN, 0.0, 1.0);
                addIngredient(COLES_ONION, 0.0, 1.0);
                addIngredient(COLES_ORANGE, 0.0, 1.0);
                addIngredientByWeight(COLES_OREGANO, 0.0, 1.0);
                addIngredientByWeight(COLES_PAPRIKA, 0.0, 1.0);
                addIngredientByWeight(COLES_PARSLEY, 0.0, 1.0);
                addIngredientByWeight(COLES_PASTA_WHOLEMEAL, 0.0, 1.0);
                addIngredientByWeight(COLES_PEA_FROZEN, 0.0, 1.0);
                addIngredientByWeight(COLES_PEPPER, 0.0, 1.0);
                addIngredientByWeight(COLES_PORK_SPARE_RIBS, 0.0, 1.0);
                addIngredientByWeight(COLES_POTATO, 0.0, 1.0);
                addIngredientByWeight(COLES_PRAWN_KING, 0.0, 1.0);
                addIngredientByWeight(COLES_PUMPKIN, 0.0, 1.0);
                addIngredientByWeight(COLES_TAMARI, 0.0, 1.0);
                addIngredientByWeight(COLES_QUINOA_ORGANIC, 0.0, 1.0);
                addIngredientByWeight(COLES_RADISH, 0.0, 1.0);
                addIngredientByWeight(COLES_RASPBERRY_FROZEN, 0.0, 1.0);
                addIngredientByWeight(COLES_RHUBARB, 0.0, 1.0);
                addIngredientByWeight(COLES_RICE_BROWN, 0.0, 1.0);
                addIngredientByWeight(COLES_ROCKET, 0.0, 1.0);
                addIngredientByWeight(COLES_SALAMI_HUNGARIAN, 0.0, 1.0);
                addIngredientByWeight(COLES_SALMON, 0.0, 1.0);
                addIngredientByWeight(COLES_SALMON_SMOKED, 0.0, 1.0);
                addIngredientByWeight(COLES_SALT_SEA, 0.0, 1.0);
                addIngredient(COLES_SARDINE_IN_OIL_UNDRAINED, 0.0, 1.0);
                addIngredientByWeight(COLES_SAUSAGE_BEEF, 0.0, 1.0);
                addIngredientByWeight(COLES_SAUSAGE_CHORIZO, 0.0, 1.0);
                addIngredientByWeight(COLES_SAUSAGE_PORK, 0.0, 1.0);
                addIngredientByWeight(COLES_SEED_CHIA, 0.0, 1.0);
                addIngredientByWeight(COLES_SEED_LINSEED, 0.0, 1.0);
                addIngredientByWeight(COLES_SEED_SUNFLOWER, 0.0, 1.0);
                addIngredientByWeight(COLES_SHALLOT, 0.0, 1.0);
                addIngredientByWeight(COLES_SNOW_PEA, 0.0, 1.0);
                addIngredientByWeight(COLES_SPINACH, 0.0, 1.0);
                addIngredient(COLES_SQUASH, 0.0, 1.0);
                addIngredientByWeight(COLES_SQUID, 0.0, 1.0);
                addIngredientByWeight(COLES_STRAWBERRY_FROZEN, 0.0, 1.0);
                addIngredientByWeight(COLES_STRAWBERRY, 0.0, 1.0);
                addIngredientByWeight(COLES_SWEET_POTATO, 0.0, 1.0);
                addIngredientByWeight(COLES_SWEETCORN_FROZEN, 0.0, 1.0);
                addIngredientByWeight(COLES_TEA_CHAI, 0.0, 1.0);
                addIngredientByWeight(COLES_TEA_GREEN, 0.0, 1.0);
                addIngredientByWeight(COLES_TEA_CHAMOMILE, 0.0, 1.0);
                addIngredientByWeight(COLES_TEA_MINT, 0.0, 1.0);
                addIngredientByWeight(COLES_TEA_BLACK, 0.0, 1.0);
                addIngredientByWeight(COLES_TOMATO_CHERRY, 0.0, 1.0);
                addIngredient(COLES_TOMATO, 0.0, 1.0);
                addIngredientByWeight(COLES_TROUT, 0.0, 1.0);
                addIngredient(COLES_TUNA_IN_OIL_DRAINED, 0.0, 1.0);
                addIngredient(COLES_TUNA_IN_WATER_DRAINED, 0.0, 1.0);
                addIngredientByWeight(COLES_VEAL, 0.0, 1.0);
                addIngredientByWeight(COLES_WATERCRESS, 0.0, 1.0);
                addIngredientByWeight(COLES_YOGHURT_GREEK_STYLE_NATURAL, 0.0, 1.0);
