...
public enum FoodItem {
    ...
    COLES_APPLE_RED_DELICIOUS(Food.APPLE_RED_DELICIOUS_UNPEELED_RAW, 180, 1, 14, 0.99),
    ...
    COLES_AVOCADO(Food.AVOCADO_RAW, 225, 1, 7, 2.50),
    COLES_AVOCADO_ORGANIC(Food.AVOCADO_RAW, 225, 1, 7, 4.50),
    ...
    COLES_BREAD_FROM_WHOLEMEAL_FLOUR(Food.BREAD_FROM_WHOLEMEAL_FLOUR_COMMERCIAL, 700, 14, 14, 1.50),
    COLES_BREAD_MIXED_GRAIN(Food.BREAD_MIXED_GRAIN_COMMERCIAL, 850, 18, 14, 3.50),
    ...
    COLES_CAPSICUM_GREEN(Food.CAPSICUM_GREEN_FRESH_OR_FROZEN_RAW, 250, 1, 7, 1.25),
    COLES_CAPSICUM_RED(Food.CAPSICUM_RED_FRESH_OR_FROZEN_RAW, 320, 1, 7, 1.28),
    ...
    COLES_CHEESE_BRIE(Food.CHEESE_BRIE, 125, 2, 21, 3.00),
    COLES_CHEESE_CAMEMBERT(Food.CHEESE_CAMEMBERT, 125, 2, 21, 3.00),
    ...
    COLES_CHICKEN_BREAST_FREE_RANGE(Food.CHICKEN_BREAST_FLESH_RAW, 700, 5, 7, 11.20),
    ...
    COLES_CHILLI(Food.CHILLI_RAW_NOT_FURTHER_DEFINED, 50, 10, 21, 1.25),
    ...
    COLES_NUT_ALMOND(Food.NUT_ALMOND_WITH_OR_WITHOUT_SKIN_RAW_UNSALTED, 400, 20, 21, 9.00),
    ...
    COLES_NUT_WALNUT(Food.NUT_WALNUT_RAW_UNSALTED, 400, 20, 21, 9.00),
    ...
    COLES_SEED_CHIA(Food.SEED_CHIA_DRIED, 300, 30, 28, 12.09),
    COLES_SEED_LINSEED(Food.SEED_LINSEED_OR_FLAXSEED, 500, 50, 28, 5.28),
    COLES_SEED_PUMPKIN(Food.SEED_PUMPKIN_HULLED_DRIED_UNSALTED, 100, 10, 28, 2.09),
    COLES_SEED_SESAME(Food.SEED_SESAME_UNSALTED, 230, 23, 28, 4.90),
    COLES_SEED_SUNFLOWER(Food.SEED_SUNFLOWER_UNSALTED, 200, 20, 28, 2.37),
    ...
    COLES_SWEET_POTATO(Food.SWEET_POTATO_ORANGE_FLESH_PEELED_OR_UNPEELED_FRESH_OR_FROZEN_BOILED_MICROWAVED_OR_STEAMED_DRAINED, 350, 2, 7, 1.74),
