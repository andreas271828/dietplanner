...
public enum FoodItem {
    COLES_APPLE_RED_DELICIOUS(Food.APPLE_RED_DELICIOUS_UNPEELED_RAW, 180, 1, 0.99),
    COLES_APPLE_RED_DELICIOUS_1KG(Food.APPLE_RED_DELICIOUS_UNPEELED_RAW, 1000, 6, 5.30),
    COLES_ASPARAGUS_GREEN(Food.ASPARAGUS_GREEN_RAW, 200, 4, 2.70),
    COLES_AVOCADO(Food.AVOCADO_RAW, 225, 1, 1.80),
    COLES_AVOCADO_ORGANIC(Food.AVOCADO_RAW, 225, 1, 4.50),
    ...
    COLES_BEEF_ROASTING_CUTS(Food.BEEF_ROASTING_CUTS_UNTRIMMED_RAW, 1.5, 6, 21.00),
    ...
    COLES_BEEF_T_BONE_STEAK(Food.BEEF_T_BONE_STEAK_UNTRIMMED_RAW, 800, 3, 17.60),
    COLES_BEETROOT(Food.BEETROOT_PURPLE_PEELED_FRESH_OR_FROZEN_RAW, 170, 1, 0.68),
    COLES_BEETROOT_ORGANIC(Food.BEETROOT_PURPLE_PEELED_FRESH_OR_FROZEN_RAW, 500, 3, 4.00),
    ...
    COLES_BREAD_FROM_WHOLEMEAL_FLOUR(Food.BREAD_FROM_WHOLEMEAL_FLOUR_COMMERCIAL, 700, 20, 1.50),
    COLES_BREAD_MIXED_GRAIN(Food.BREAD_MIXED_GRAIN_COMMERCIAL, 850, 20, 3.50),
    COLES_BROCCOLI(Food.BROCCOLI_FRESH_OR_FROZEN_RAW, 340, 2, 1.33),
    COLES_BRUSSELS_SPROUT(Food.BRUSSELS_SPROUT_FRESH_OR_FROZEN_RAW, 400, 6, 3.19),
    ...
    COLES_CHEESE_CHEDDAR(Food.CHEESE_CHEDDAR_NATURAL_PLAIN_REGULAR_FAT, 1000, 20, 7.15),
    COLES_CHEESE_COLBY(Food.CHEESE_COLBY_STYLE, 1000, 20, 12.93),
    COLES_CHEESE_COTTAGE_REDUCED_FAT(Food.CHEESE_COTTAGE_REDUCED_FAT, 500, 10, 3.19),
    ...
    COLES_CHEESE_MOZZARELLA(Food.CHEESE_MOZZARELLA_REGULAR_FAT, 500, 10, 8.24),
    COLES_CHEESE_PARMESAN(Food.CHEESE_PARMESAN_FRESH, 250, 5, 6.70),
    COLES_CHEESE_RICOTTA(Food.CHEESE_RICOTTA_REGULAR_FAT, 125, 2, 1.06),
    COLES_CHEESE_SWISS(Food.CHEESE_SWISS, 200, 4, 5.45),
    COLES_CHICKEN_BREAST(Food.CHICKEN_BREAST_FLESH_RAW, 500, 2, 6.00),
    COLES_CHICKEN_BREAST_FREE_RANGE(Food.CHICKEN_BREAST_FLESH_RAW, 630, 3, 11.65),
    COLES_CHICKEN_BREAST_ORGANIC(Food.CHICKEN_BREAST_FLESH_RAW, 600, 3, 18.84),
    ...
    COLES_CHICKEN_LIVER(Food.CHICKEN_LIVER_RAW, 500, 8, 3.75),
    ...
    COLES_CHICKEN_THIGH_ORGANIC(Food.CHICKEN_THIGH_FLESH_RAW, 450, 3, 12.24),
    ...
    COLES_COCONUT_OIL_ORGANIC(Food.COCONUT_OIL, 300, 20, 12.27),
    ...
    COLES_CUCUMBER(Food.CUCUMBER_COMMON_UNPEELED_RAW, 320, 4, 0.90),
    COLES_DILL(Food.DILL_RAW, 20, 4, 2.98),
    ...
    COLES_GHEE(Food.GHEE_CLARIFIED_BUTTER, 300, 20, 6.13),
    COLES_GINGER(Food.GINGER_PEELED_FRESH_OR_FROZEN_RAW, 120, 12, 3.24),
    COLES_HAM_LEG(Food.HAM_LEG_LEAN_FAT, 125, 2, 1.81),
    COLES_HONEY(Food.HONEY, 500, 50, 7.32),
    COLES_KALE(Food.KALE_RAW, 150, 3, 2.50),
    COLES_KALE_ORGANIC(Food.KALE_RAW, 150, 3, 5.00),
    COLES_KANGAROO(Food.KANGAROO_RUMP_RAW, 380, 2, 6.65),
    COLES_KIWIFRUIT(Food.KIWIFRUIT_GREEN_HAYWARD_PEELED_RAW, 100, 1, 0.60),
    COLES_LEEK(Food.LEEK_RAW, 150, 3, 2.98),
    COLES_LEMON(Food.LEMON_PEELED_RAW, 160, 4, 1.50),
    COLES_LENTIL(Food.LENTIL_DRIED, 400, 2, 0.80),
    COLES_LETTUCE(Food.LETTUCE_RAW_NOT_FURTHER_DEFINED, 500, 5, 2.98),
    COLES_LIME(Food.LIME_PEELED_RAW, 120, 4, 1.10),
    ...
    COLES_MAYONNAISE(Food.MAYONNAISE_COMMERCIAL_REGULAR_FAT, 445, 20, 2.85),
    ...
    COLES_MUESLI_FRUIT(Food.MUESLI_COMMERCIAL_UNTOASTED_OR_NATURAL_STYLE_ADDED_DRIED_FRUIT_UNFORTIFIED, 750, 10, 3.85),
    COLES_MUESLI_FRUIT_NUTS(Food.MUESLI_COMMERCIAL_UNTOASTED_OR_NATURAL_STYLE_ADDED_DRIED_FRUIT_NUTS_UNFORTIFIED, 550, 10, 5.50),
    COLES_MUSHROOM(Food.MUSHROOM_COMMON_FRESH_OR_FROZEN_RAW, 200, 10, 2.00),
